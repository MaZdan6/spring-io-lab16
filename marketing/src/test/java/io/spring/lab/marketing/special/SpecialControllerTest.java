...
import io.spring.lab.marketing.SpringTestBase;
...
public class SpecialControllerTest extends SpringTestBase {
    ...
    public void shouldListSpecials() {
        ...
        assertThat(specials).contains(new SpecialRepresentation(1L, 3, BigDecimal.valueOf(70)));
    }
}